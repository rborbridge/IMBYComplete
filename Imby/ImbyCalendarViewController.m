//
//  ImbyCalendarViewController.m
//  Imby
//  Modified from Apple's SimpleEKDemo at https://developer.apple.com/library/ios/samplecode/SimpleEKDemo/Listings/ReadMe_txt.html
//  Created by Heather Simmons on 2014-01-27.
...
@interface ImbyCalendarViewController () <EKEventEditViewDelegate>
...
@implementation ImbyCalendarViewController
    ...
    [self.eventStore requestAccessToEntityType:EKEntityTypeEvent completion:^(BOOL granted, NSError *error)
     {
         if (granted)
         {
             ImbyCalendarViewController * __weak weakSelf = self;
             // Ensures that code will be executed from the main queue
             dispatch_async(dispatch_get_main_queue(), ^{
                 // Populate UI with all events occuring in the next 24 hours.
...
{
    // Get the default calendar associated with our event store
...
- (NSMutableArray *)fetchEvents
{
    ...
    NSDate *endDate = [[NSCalendar currentCalendar] dateByAddingComponents:tomorrowDateComponents
                                                                    toDate:startDate
                                                                   options:0];
	// Search the default calendar for events
